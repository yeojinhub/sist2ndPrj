...
<script>
    $(function(){
        $('#deleteBtn').on('click', function(e){
            e.preventDefault();
            alert("리뷰가 삭제되었습니다.");
            window.opener.$('.content').load('../common/component/mypage/myReview.jsp', function(response, status, xhr) {
                if (status === "error") {
    ...
    <div class="content" style="text-align: center;">
        ...
        <form id="changePassForm" method="post" action="popupDeleteAccountConfirm.jsp" style="width: 400px; margin: 0 auto; text-align: left;">
            ...
            <div class="button-group" style="text-align: center; margin-top: 100px;">
                <button type="submit" class="btn btn-confirm" style="width: 150px;" id="deleteBtn">삭제</button>
