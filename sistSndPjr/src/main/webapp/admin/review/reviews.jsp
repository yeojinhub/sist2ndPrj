				...
				<table class="data-table">
					...
					<c:forEach var="review" items="${reviewList}">
					    <tr>
					        ...
					        <td class="onclickbtn" onclick="location.href='review_detail.jsp?revNum=${review.rev_num}'"><c:out value="${review.area_name}" /></td>
					        <td class="onclickbtn" onclick="location.href='review_detail.jsp?revNum=${review.rev_num}'"><c:out value="${review.content}" /></td>
