...
<div class="sidebar">
   <div class="logo-container">
     <img src="/sistSndPjr/admin/common/images/logo251.png" onclick="location.href='/sistSndPjr/admin/home.jsp'" alt="로고" class="onclickbtn logo">
   </div>
   ...
   <ul class="menu">
      ...
      <li class="menu-item has-submenu"><a href="#"
         ...
         <ul class="submenu">
            <li><a href="/sistSndPjr/admin/board/notice/notice_board.jsp">공지사항 관리</a></li>
            <li><a href="/sistSndPjr/admin/board/faq/faq_board.jsp">FAQ 관리</a></li>
         </ul></li>
