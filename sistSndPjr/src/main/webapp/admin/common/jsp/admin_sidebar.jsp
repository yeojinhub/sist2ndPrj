...
<div class="sidebar">
	<div class="logo-container">
		<img src="/sistSndPjr/admin/common/images/logo251.png"
			onclick="location.href='/sistSndPjr/admin/home.jsp'" alt="로고"
			class="onclickbtn logo">
	</div>
	...
	<ul class="menu">
		...
		<li class="menu-item has-submenu"><a href="#"
			...
			<ul class="submenu">
				<li><a href="/sistSndPjr/admin/account/user_account_list.jsp">회원
						계정관리</a></li>
				<li><a href="/sistSndPjr/admin/account/admin_account_list.jsp">관리자
						계정관리</a></li>
			</ul></li>
		<li class="menu-item has-submenu"><a href="#"
			...
			<ul class="submenu">
				<li><a href="/sistSndPjr/admin/board/notice_board.jsp">공지사항
						관리</a></li>
				<li><a href="/sistSndPjr/admin/board/faq_board_list.jsp">FAQ
						관리</a></li>
			</ul></li>
		<li class="menu-item"><a
			href="/sistSndPjr/admin/inquiry/inquiries.jsp"><i
				class="fas fa-question-circle"></i> 문의 관리</a></li>
		<li class="menu-item"><a
			href="/sistSndPjr/admin/review/reviews.jsp"><i
