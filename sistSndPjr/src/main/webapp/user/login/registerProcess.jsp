<%@page import="user.account.register.RegisterService"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info=""%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<% request.setCharacterEncoding("UTF-8"); %>
<jsp:useBean id="aDTO" class="user.account.register.AccountDTO" scope="page"/>
...
<body>
	...
	<div>
		<img src="../common/images/main_pic.png" alt="배경 이미지"
			class="background-image"> <a href="../main/user_main_page.jsp"
			class="logo-container"> <img src="../common/images/logo251.png"
			alt="모두쉼 로고" class="logo-image">
		</a> <a href="../main/user_main_page.jsp" class="mobile-logo"> <img
			...
			<c:choose>
				<c:when test="${registerFlag }">
					<div style="text-align: center; font-size: 30px;">
						...
						<p>회원가입이 완료되었습니다.</p>
						<p>메인화면으로 이동합니다.</p>
						<meta http-equiv="refresh" content="2;../main/user_main_page.jsp" />
					</div>
				</c:when>
				<c:otherwise>
					<div style="text-align: center; font-size: 30px;">
