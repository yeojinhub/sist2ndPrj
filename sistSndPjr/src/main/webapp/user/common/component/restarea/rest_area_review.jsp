<%@page import="user.util.ReviewPaginationUtil"%>
<%@page import="user.util.AreaDetailReviewPaginationDTO"%>
<%@page import="user.restarea.detail.review.RestAreaDetailReviewService"%>
<%@ page contentType="text/html; charset=UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<% request.setCharacterEncoding("UTF-8"); %>
<jsp:useBean id="adrrDTO" class="user.util.AreaDetailReviewRangeDTO" scope="page"/>
